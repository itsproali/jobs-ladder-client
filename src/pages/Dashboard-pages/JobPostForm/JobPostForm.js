        ...
        <form onSubmit={handleJobPost} ref={formRef}>
          ...
          <div class="md:flex md:justify-between">
            ...
            <div class="w-full md:w-8/12 mb-4 md:mb-0">
              ...
              <input type="text" class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 rounded py-2 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500" id="location" name="location" placeholder="Dhaka , Bangladesh" />
          ...
          <div>
            ...
            <textarea name="description" id="description" className='w-full p-3 border border-gray-300 h-40 rounded'></textarea>
          </div>
